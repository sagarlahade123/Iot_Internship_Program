...
try:
    while True:
            ...
            cursur1.execute("insert into Table1(Sensor_Name ,Tempreture,Humidity ,Pressure ,Date_Time ,Device_id)values(?,?,?,?,?,?)",("Pressure_sensor","NA","NA",pressure_Sensehat,date_time,Device_ID_Pressure))
