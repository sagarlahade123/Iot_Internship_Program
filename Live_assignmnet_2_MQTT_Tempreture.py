...
try:
    while True:
        ...
        cursur1.execute("insert into Table2(Sensor_Name ,Tempreture,Humidity ,Pressure ,Date_Time ,Device_id)values(?,?,?,?,?,?)",(Sensor_Name,tempreture_Sensehat,"NA","NA",date_time,Device_ID_Temp))
