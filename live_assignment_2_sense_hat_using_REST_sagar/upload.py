        ...
        try:
            ...
            while True:
                for data_to_send in data:
                    ...
                    data_to_iotsense={"deviceId":deviceId}
                    ...
                    data_to_iotsense.__setitem__("data",data_of_sensor)

                    while True:
                        result_of_upload_query = requests.post(url=url_to_upload, json=data_to_iotsense)
                        if result_of_upload_query.status_code == 200:
                            ...
                            print("rest send fail... so goes into sleep for 30 sec")
                            logger.info("rest send fail... so goes into sleep for 30 sec")
                            connection.close()
                            logger.info("sqlite connection clolsed")
                            print("sqlite connection clolsed")
                            sqlite_connection=False
