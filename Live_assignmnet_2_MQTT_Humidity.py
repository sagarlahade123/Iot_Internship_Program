...
try:
    while True:
            ...
            cursur1.execute("insert into Table2(Sensor_Name ,Tempreture,Humidity ,Pressure ,Date_Time ,Device_id)values(?,?,?,?,?,?)",("Humidity_sensor","NA",humidity_SenseHat,"NA",date_time,Device_ID_Humidity))
